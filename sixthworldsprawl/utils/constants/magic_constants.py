ASSCENING_TEST_RESULTS  = {
    ...
    "SIGNATURE" : {
        ...
        "HIGH" : "Any astral signatures present on the subject, along with their general cuase (combat spell, hearth spirit, etc.) and if you have seen the subject's aura before, you will recognize it, regardless of physical disguises or alterations."
    },
    "CLASS" : {
        # This section doesnt have a varying level of success so the results will be the same no matter what. 
